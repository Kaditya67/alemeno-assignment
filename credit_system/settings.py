...
SECRET_KEY = 'django-insecure-+5*phlqag8z_1cly1o600br(_u$xqvn3mkr*rpe&5p0&+w1jxr'
...
DATABASES = {
    "default": {
        ...
        "USER": os.getenv("DATABASE_USER", "credituser"),
        "PASSWORD": os.getenv("DATABASE_PASSWORD", "creditpass"),
